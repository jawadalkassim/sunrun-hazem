                            ...
                            <form id="msform" class="form" action="thank-you.php?" novalidate method="post">
                                ...
                                <fieldset id="form-step9" class="form-steps fieldset-9" data-step="9" style="display: none;" data-tag="address">
                                    ...
                                    <div class="form-group" id="street-address-verify" style="display: none;">
                                        <label>Did you mean...? (Click en la opción que mejor se asemeje)</label>
                                ...
                                <fieldset id="form-step10" class="form-steps fieldset-8" data-step="10" style="display: none;" data-tag="address">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-btns ml-auto text-right">
                                                <button id="q10-next" class="btn form-btn btn-next" type="button"><span class="btn-text">Siguiente</span>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <fieldset id="form-step11" class="form-steps fieldset-10" data-step="11" style="display: none;" data-tag="phone">
                                    ...
                                    <div class="col colback col-last"><button type="button" class="btn btn-link btn-back just-text">Atrás</button></div> 
                                    
                                    <!-- <div class="col colback"><a class="btn btn-link btn-back">Back</a></div>  -->

                                        <div class="col">
                                            <div class="form-btns ml-auto text-right btn-last-submit">
                                                <button id="q11-next" class="btn form-btn btn-next btn-final" type="button"><span class="btn-text">Siguiente</span>
                                                </button>
        ...
        <div class="modal-content">
            ...
            <div class="tcpa-content-container">
                <div id="terms-php" class="hidden">
                    ...
                    <p>Welcome to solar-savings-today.com!</p>

                    <p>These terms and conditions outline the rules and regulations for the use of For the deal's Website, located at solar-savings-today.com.</p>

                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use solar-savings-today.com if you do not agree to take all of the terms and conditions stated on this page.</p>
                    ...
                    <p>We employ the use of cookies. By accessing solar-savings-today.com, you agreed to use cookies in agreement with the For the Deal's <a href="privacy-policy.php" target="_new">Privacy Policy</a>. </p>

                    <p>Most interactive websites use cookies to let us retrieve the user's details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.</p>

                    <h3><strong>License</strong></h3>

                    <p>Unless otherwise stated, For the Deal and/or its licensors own the intellectual property rights for all material on solar-savings-today.com. All intellectual property rights are reserved. You may access this from solar-savings-today.com for your own personal use subjected to restrictions set in these terms and conditions.</p>

                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from solar-savings-today.com</li>
                        <li>Sell, rent or sub-license material from solar-savings-today.com</li>
                        <li>Reproduce, duplicate or copy material from solar-savings-today.com</li>
                        <li>Redistribute content from solar-savings-today.com</li>
                    </ul>
                ...
                <div id="privacy-php" class="hidden">
                    ...
                    <p>At solar-savings-today.com, accessible from https://solar-savings-today.com/, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by solar-savings-today.com and how we use it.</p>

                    <p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.</p>

                    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in solar-savings-today.com. This policy is not applicable to any information collected offline or via channels other than this website.</p>
                   ...
                   <p>If, after you have shared your information with us, you decide that you do not want to receive marketing communications from Provider, you can discontinue the communications by sending an opt-out request to the Contact Us information listed below</p> 
                    ...
                    <p>solar-savings-today.com follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information.</p>

                    <h2>Cookies and Web Beacons</h2>

                    <p>Like any other website, solar-savings-today.com uses "cookies". These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</p>

                    <h2>Advertising Partners Privacy Policies</h2>

                    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of solar-savings-today.com.</p>

                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on solar-savings-today.com, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.</p>

                    <p>Note that solar-savings-today.com has no access to or control over these cookies that are used by third-party advertisers.</p>

                    <h2>Third Party Privacy Policies</h2>

                    <p>solar-savings-today.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. </p>
                    ...
                    <p>solar-savings-today.com does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.</p>
                        ...
                        */
                        ...
                        [
                            ...
                            () => {
                                        ...
                                        //const ipadr = null
                                      //  console.log(ipadr);
                                        const data = `lp_campaign_id=6554f6989d710&lp_campaign_key=d6QqhHTjRGVNwxPtpXcC&lp_response=JSON&homeowner=${property_ownership}&utility_electric_monthly_amount=${electric_bill}&roof_shade=${roof_shade}&first_name=${first_name}&last_name=${last_name}&phone_home=${phone_home}&address_1=${address}&email_address=${email}&city=${city}&state=${state}&zip_code=${zip}&solar_electric=true&ip_address=${ipadr}&trusted_form_cert_id=${document.querySelector("#xxTrustedFormCertUrl_0").value}&lp_s1=194S&lp_s2=${s1}&jornaya_lead_id=${jornaya}&utility_electric_company_name=${provider}&tcpa_text=Al hacer clic en Siguiente, acepto los Términos, Privacidad , y consentimiento para Solar Savings Today para enviar mensajes pregrabados de marketing y llamadas/textos automáticamente a mi número de teléfono anterior, incluso si está en alguna lista de no llamar. El consentimiento no es una condición de compra. Puede darse de baja en cualquier momento (ver Términos). Se pueden aplicar tarifas de mensajes/datos.`;
                                        console.log('tf data')
                                        var payout = 0;
                                        console.log(data)
                                        const statePayouts = {
